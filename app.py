...
def generate_rag_response(original_query, search_query, contexts):
    ...
    prompt = (
        ...
        f"Consulta original del usuario (Español): {original_query}\n"
        f"Consulta equivalente de búsqueda (Inglés): {search_query}\n\n"
        f"Respuesta estructurada (en español):"
    )
